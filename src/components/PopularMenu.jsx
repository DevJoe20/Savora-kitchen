const PolpularMenu = () => {
  const whatsappNumber = "2348141401872";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {dishes.map((dish, index) => {
            const message = `Hello Savora Kitchen, I'd like to order ${dish.name} — ${dish.price}.`;
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <a
                    ...
                    className="block text-center w-full mt-5 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg transition"
                  >
                    Order Now
                  </a>
                </div>
